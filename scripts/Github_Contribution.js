...
const Cache = importModule('Cache_GitHub');
const cache = new Cache('github-heatmap');

// Configuration and constants
const GITHUB_USERNAME = args.widgetParameter || "TODO"; // your Github username
const GITHUB_TOKEN = "TODO"; // your Github Token
const GITHUB_API_URL = "https://api.github.com/graphql";

const DAY_COLOR = config.runsInAccessoryWidget ? "#45548a" : null; //#ffffff
const COLUMNS = 16;
const ROWS = 7;
const CELL_SIZE = 8;
const PADDING = 2;
...
async function createWidget() {
    ...
    widget.backgroundColor=new Color("#222222", 0)
